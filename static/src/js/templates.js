  ...
  <div>
    ...
    ${Array.isArray(game.images.screenshot) ? `
      ...
      <div class="carousel game-preview-images">
        ...
        ${game.images.screenshot.map((img) => `<img alt="" width="345" height="194" loading="lazy" decoding="async" src="${img.url}?w=1160" />`).join('')}
      </div>
    ` : ''}
...
<article class="game-preview-soon">
  ${gameInfoTemplate(game)}
  <img class="game-img" width="256px" height="144px" alt="" loading="lazy" decoding="async" src="${img}?w=512">
</article>
`);
}
...
<article class="game-important">
  ...
  <img class="game-img" width="330px" height="330px" alt="" fetchpriority="high" decoding="async" src="${img}?w=720">
</article>
  `);
}
